...
public class DeliveryRoundTest extends TestCase {
	 ...
	 * public void testAddDelivery(){
	 * 
	 * Section s1 = new Section("r1",1,2,3.0,3.0); ArrayList <Section> sections1
	 * = new ArrayList<Section>(); sections1.add(s1); Section s2 = new
	 * Section("r2",2,3,3.0,3.0); ArrayList <Section> sections2 = new
	 * ArrayList<Section>(); sections2.add(s2); Delivery d1 = new
	 * Delivery(1,1,1); Delivery d2 = new Delivery(2,2,2); Delivery d3 = new
	 * Delivery(3,3,3); Path path = new Path(d1,d2,sections1); Path path2 = new
	 * Path(d2,d3,sections2); ArrayList <Path> paths = new ArrayList<Path>();
	 * paths.add(path); paths.add(path2); deliveryRound.setPaths(paths);
	 * 
	 * Delivery d4 = new Delivery(4,4,4); addDelivery() }
	 */
